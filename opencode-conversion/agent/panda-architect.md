...
1. **Create a todo checklist** for any multi-step task
...
### Use Instruction Files for Guidance
Refer to the Panda CSS instruction files for detailed patterns:
- **panda-setup-config**: Configuration and setup guidance
...
2. Create todo checklist with setup steps
...
1. Create todo checklist for token architecture
...
1. Create todo checklist for migration
...
- **Systematic**: Use todo lists for complex work, check off progress
